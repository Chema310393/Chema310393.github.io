 ...
 */
{
    ...
    let arrayIn = function(){
        ...
        let personas = ["Chema", "Arturo", "Antonio", "Dante"];
        let persona = {Nombre: "José", Apellido: "Romero", Edad: "25"};
        let inicio = document.createElement("ol");
            ...
            lista2.textContent = "2 in personas = " + (2 in personas);

            let lista3 = document.createElement("li");
            lista3.textContent = "9 in personas = " + (9 in personas);

            let lista4 = document.createElement("li");
            lista4.textContent = "length in personas = " + (length in personas);
