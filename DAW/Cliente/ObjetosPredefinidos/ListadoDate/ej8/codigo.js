/**
 * 8.- Implementa el método esBisiesto() que devuelva si una fecha/año es bisiesto o no. En caso de que el 
 * argumento no sea una fecha, que salte una excepción. Admitirá tantos parámetros como el constructor 
 * Date(). Pruébalo con varias invocaciones fallidas (y capturadas)
 * 
...

{
    ...
    try {
        ...
        cadena += "Año 2021: " + esBisiesto("2021");
    } catch (e) {
        //Capturo los errores.
        cadena += e.message;
    }
